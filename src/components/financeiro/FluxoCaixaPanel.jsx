...
export default function FluxoCaixaPanel() {
  ...
  const receitas = dados.filter((d) => ["receita_aluguel", "taxa_adm_imobiliaria"].includes(d.tipo));
  const despesas = dados.filter((d) => !["receita_aluguel", "taxa_adm_imobiliaria"].includes(d.tipo));
