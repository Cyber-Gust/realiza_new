...
export default function ImovelDetailPageClient({ imovelId }) {
 ...
 /* ======================================================
  ...
  return (
    // 👇 1. Coloquei tudo dentro de um Fragment (estas tags vazias <>)
    <>
      {/* 👇 2. Adicionei a classe "print:hidden" nesta div principal */}
      ...
      {/* 👇 3. O COMPONENTE DE IMPRESSÃO FICA AQUI, FORA DA DIV QUE É ESCONDIDA! */}
      <FichaImovelPrint 
        imovel={imovel} 
